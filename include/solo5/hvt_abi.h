...
/*
 * Each requested PCIe region (including configuration space) will be mapped
 * starting at HVT_PCI_REGION_BASE with HVT_PCI_REGION_OFFSET between
 * regions and HVT_PCI_DEVICE_OFFSET between devices.
 */
